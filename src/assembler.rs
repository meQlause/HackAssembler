...
impl HackAssembler {
    ...
    /// Creates a new `HackAssembler` instance with the specified input file.
    ///
    /// # Arguments
    ///
    ...
    /// # Returns
    ///
    /// A new `HackAssembler` instance with the specified input file loaded.
    ///
    /// # Examples
    ///
    /// ```
    /// // Create a new instance of the HackAssembler and load the file "program.asm"
    /// let assembler = HackAssembler::new(&String::from("program.asm"));
    /// ```
    pub fn new(file: &String) -> Self {
        ...
        HackAssembler {
            file: match File::open(file.to_string()) {
    ...
    fn c_instruction(&self, a: &String) -> String {
        ...
        println!("{}{}{}{} = {}", to_return, comp, dst, jmp, re_ins[0]);
